...
namespace Sante.EMR.SmartClient.Infrastructure.Interface.BusinessEntities
{
    ...
    public class MCTDispatch : Form
    {
        ...
        private string _divertedJail;
        private string _divertedER;
        private string _otherInterventions;
        private string _otherOutcomes;
        private string _otherOutcomeDet;
        private string _divertedIC;
        private string _mobileTreatmentTeam;
        private string _residentialAddictionsTreatment;
        private string _mobileCrisisStabilizationServices;
        private string _directServicesProvider;
        private string _hotline;
        private string _pCPReferral;
        private string _eDDepartmentSupport;
        private string _pRPReferral;
        private string _mCTTeam;
        private string _interventions;
        private string _focalIssues;
        ...
        public string FocalIssues
        {
            get { return _focalIssues; }
            set { _focalIssues = value; }
        }
        ...
        public string DivertedJail
        {
            get { return _divertedJail; }
            set { _divertedJail = value; }
        }

        public string DivertedER
        {
            get { return _divertedER; }
            set { _divertedER = value; }
        }

        public string OtherInterventions
        {
            get { return _otherInterventions; }
            set { _otherInterventions = value; }
        }

        public string OtherOutcomes
        {
            get { return _otherOutcomes; }
            set { _otherOutcomes = value; }
        }

        public string OtherOutcomeDet
        {
            get { return _otherOutcomeDet; }
            set { _otherOutcomeDet = value; }
        }
        
        public string DivertedIC
        {
            get { return _divertedIC; }
            set { _divertedIC = value; }
        }

        public string MobileTreatmentTeam
        {
            get { return _mobileTreatmentTeam; }
            set { _mobileTreatmentTeam = value; }
        }

        public string ResidentialAddictionsTreatment
        {
            get { return _residentialAddictionsTreatment; }
            set { _residentialAddictionsTreatment = value; }
        }

        public string MobileCrisisStabilizationServices
        {
            get { return _mobileCrisisStabilizationServices; }
            set { _mobileCrisisStabilizationServices = value; }
        }

        public string DirectServicesProvider
        {
            get { return _directServicesProvider; }
            set { _directServicesProvider = value; }
        }
        ...
        public string PCPReferral
        {
            get { return _pCPReferral; }
            set { _pCPReferral = value; }
        }

        public string EDDepartmentSupport
        {
            get { return _eDDepartmentSupport; }
            set { _eDDepartmentSupport = value; }
        }

        public string PRPReferral
        {
            get { return _pRPReferral; }
            set { _pRPReferral = value; }
        }

        public string MCTTeam
        {
            get { return _mCTTeam; }
            set { _mCTTeam = value; }
        }
