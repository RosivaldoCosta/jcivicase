...
using Sante.EMR.SmartClient.CISM.Properties;
using Sante.EMR.SmartClient.CISM.Constants;
...
namespace Sante.EMR.SmartClient.CISM
{
    public class ModuleController : WorkItemController
    {
        ...
        {
            this.RegisterLaunchPoint(Properties.Resources.ModuleTitle, Properties.Resources.CISMIcon, CommandNames.CISMMenu);
        
        }

        [CommandHandler(CommandNames.CISMMenu)]
        public void OnCISMMenu(object sender, EventArgs e)
        {
