...
using Sante.EMR.SmartClient.Module.CISM.Constants;

namespace Sante.EMR.SmartClient.Module.CISM
{
    public class ModuleController : WorkItemController
    {
        ...
        {
            this.RegisterLaunchPoint(CommandNames.QueryCISM, Properties.Resources.CISMIcon, Properties.Resources.ModuleTitle);
        }

        [CommandHandler(CommandNames.QueryCISM)]
        public void OnQueryCISM(object sender, EventArgs e)
        {
           // MessageBox.Show("Query CISM invoked");
            ShowViewInWorkspace<CISMView>(WorkspaceNames.PrimaryWorkspace);
        }
