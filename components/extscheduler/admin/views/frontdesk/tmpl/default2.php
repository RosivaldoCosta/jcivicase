...
<link rel="stylesheet" type="text/css" href="<?php echo $extpath; ?>resources/css/ext-all.css" />
    ...
    <script type="text/javascript" src="<?php echo $extpath; ?>src/EventEditForm.js"></script>
         <!--<script type="text/javascript" src="<?php echo $extpath; ?>src/CustomEventEditWindow.js"></script>-->
     
     <script type="text/javascript" src="index.php?option=com_extscheduler&view=eventeditwindow&format=raw&controller=calendar"></script>
...
<!-- Extensible includes -->
   ...
   <!--<script type="text/javascript" src="<?php echo $extpath; ?>app/extscheduler.js"></script>-->
