		...
		switch($document->getType())
		{
			case 'html' :
			{
				...
				if ( $user->get('id') ) {
					...
					//$document->addScript( http://c498950.r50.cf2.rackcdn.com/joomla.javascript.js');
				}

				//JHTML::_('behavior.mootools');
				$document->addScript( 'http://c498950.r50.cf2.rackcdn.com/mootools.js');
			} break;
