...
(function($) {
    $.fn.makeAsyncUploader = function(options) {
        return this.each(function() {
            ...
            container.append($("<input type='hidden' name='" + id + "_guid'/><br />"));
			container.append($("<div class='ProgressBar'> <div>&nbsp;</div> </div><br />"));
            container.append($("<span id='" + id + "_completedMessage'/><br />"));
            container.append($("<span id='" + id + "_uploading'>Uploading... <input type='button' value='Cancel'/></span><br />"));
            ...
            var defaults = {
                ...
                upload_success_handler: function(file, response) {
                    ...
                    $("span[id$=_completedMessage]", container).html(response);
                },
