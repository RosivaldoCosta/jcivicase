 ...
 * @version    $Id: DbTable.php 10020 2009-08-18 14:34:09Z j.fischer@metaways.de $
 */
...
class Zend_Auth_Adapter_DbTable implements Zend_Auth_Adapter_Interface
{
    ...
    /* public function authenticate()
	{
		...
		require_once('/var/www/html/staging/libraries/joomla/user/helper.php');
		...
		$dbSelect = clone $this->getDbSelect();
        	$dbSelect->from($this->_tableName) //, array('*', $credentialExpression))
                ...
                $query = 'SELECT `id`,'.$this->_credentialColumn.'
                        . ' FROM '.$this->_tableName 
                        . ' WHERE username=' . $db->Quote( $this->_identify )
                        ;
                $db->setQuery( $query );
