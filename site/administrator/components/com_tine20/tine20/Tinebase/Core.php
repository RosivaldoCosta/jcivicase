 ...
 * @version     $Id: Core.php 19009 2011-02-02 10:56:08Z l.kneschke@metaways.de $
 *
 */
...
class Tinebase_Core
{
    ...
    public static function setupSession()
    {
        ...
        define('TINE20_CODENAME',      'Neele');
        define('TINE20_PACKAGESTRING', '2011-01-2');
        define('TINE20_RELEASETIME',   '2011-02-02 21:33:55+01:00');
    ...
    public static function setupStreamWrapper()
    {
        if (empty(Tinebase_Core::getConfig()->filesdir)) {
            Tinebase_Core::getLogger()->notice(__METHOD__ . '::' . __LINE__ . " filesdir config value not set. tine20:// streamwrapper not registered.");
