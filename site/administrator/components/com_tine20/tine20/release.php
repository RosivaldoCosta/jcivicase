 ...
 * @version     $Id: release.php 18439 2011-01-07 17:46:43Z l.kneschke@metaways.de $
 */
...
$build = '2011-01-2' . ' '. Tinebase_DateTime::now()->get(Tinebase_Record_Abstract::ISO8601LONG);
...
function concatJs(array $_files, $_filename)
{
    ...
    foreach ($_files as $file) {
        ...
        if (file_exists("$tine20path/$filename")) {
            ...
            $jsContent = preg_replace('/Tine\.clientVersion\.codeName.*;/i',      "Tine.clientVersion.codeName = 'Neele';", $jsContent);
            $jsContent = preg_replace('/Tine\.clientVersion\.buildType.*;/i',     "Tine.clientVersion.buildType = 'RELEASE';", $jsContent);
            ...
            $jsContent = preg_replace('/Tine\.clientVersion\.packageString.*;/i', "Tine.clientVersion.packageString = '2011-01-2';", $jsContent);
