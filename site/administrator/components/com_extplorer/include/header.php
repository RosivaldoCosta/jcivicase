...
function show_header($dirlinks='') {
	...
	// Logo
	echo "</td><td style=\"color:black;\" width=\"10%\"></td>";
	...
	//	</td>";
	//echo "</div>";
	echo "<td style=\"padding-left: 15px; color:black;\" width=\"35%\"></td>\n";
	echo "<td width=\"25%\" style=\"padding-left: 15px; color:black;\"><br/><br/>";
