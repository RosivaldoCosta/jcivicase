...
*/        
        var ds = new Ext.data.Store({
            proxy: new Ext.data.HttpProxy({
                url: 'index.php?option=com_civicrm&task=civicrm/ajax/contacts/&context=scheduler' /*index.php?option=com_civicrm&task=civicrm/ajax/contactlist&context=scheduler'*/
            }),
        ...
        this.dentistField = new Ext.form.TextField({
            fieldLabel: 'Dentist',
            name: Ext.calendar.EventMappings.Dentist.name,
            anchor: '100%'
	});
        this.hygienistField = new Ext.form.TextField({
            fieldLabel: 'Hygienist',
            name: Ext.calendar.EventMappings.Hygienist.name,
            anchor: '100%'
	});
        this.assistantField = new Ext.form.TextField({
            fieldLabel: 'Assistant',
            name: Ext.calendar.EventMappings.Assistant.name,
            anchor: '100%'
	});
        this.statusField = new Ext.form.TextField({
            fieldLabel: 'Confirmation Status',
            name: Ext.calendar.EventMappings.ConfirmationStatus.name,
            anchor: '100%'
	});
        this.chairField = new Ext.form.TextField({
            fieldLabel: 'Chair',
            name: Ext.calendar.EventMappings.Chair.name,
            anchor: '100%'
	});
        this.serviceField = new Ext.form.TextField({
            fieldLabel: 'Type of Service',
            name: Ext.calendar.EventMappings.TypeOfService.name,
            anchor: '100%'
	});
        this.timearrivedField = new Ext.calendar.DateRangeField({
            fieldLabel: 'Time Arrived',
            name: Ext.calendar.EventMappings.TimeArrived.name,
            anchor: '100%'
	});
        this.timeseatedField = new Ext.calendar.DateRangeField({
            fieldLabel: 'Time Seated',
            name: Ext.calendar.EventMappings.TimeSeated.name,
            anchor: '100%'
	});
        this.timedismissedField = new Ext.calendar.DateRangeField({
            fieldLabel: 'Time Dismissed',
            name: Ext.calendar.EventMappings.TimeDismissed.name,
            anchor: '100%'
	});
        this.labcaseField = new Ext.form.TextField({
            fieldLabel: 'Lab Case',
            name: Ext.calendar.EventMappings.LabCase.name,
            anchor: '100%'
	});
        ...
        rightFields = [this.notesField, this.serviceField];
...
Ext.reg('extensible.eventeditform', Ext.calendar.EventEditForm);
