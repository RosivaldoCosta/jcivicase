...
var ds = new Ext.data.Store({
        proxy: new Ext.data.HttpProxy({
            ...
            url: 'http://184.106.42.240/flexdds/administrator/index.php?option=com_civicrm&task=civicrm/ajax/contactlist&context=scheduler'
        }),
...
Ext.calendar.EventEditWindow = function(config) {
    ...
    Ext.calendar.EventEditWindow.superclass.constructor.call(this, Ext.apply({
        ...
        fbar: [{
            xtype: 'tbtext',
            text: '<a href="#" id="tblink">Add Services</a>'
        },
	{
            xtype: 'tbtext',
            text: '<a href="#" id="tblink">Add Tx Item</a>'
	},
	{
            xtype: 'tbtext',
            text: '<a href="#" id="tblink">Lab Cases</a>'
	},
        '->', {
            text: 'Save',
            disabled: false,
