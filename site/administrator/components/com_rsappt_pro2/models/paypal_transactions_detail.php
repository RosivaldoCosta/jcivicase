...
class paypal_transactions_detailModelpaypal_transactions_detail extends JModel
{
	...
	function store($data)
	{
		//DEVNOTE: Load table class from com_rsappt_pro2/tables/paypal_transactions_detail.php	
		$row =& $this->getTable();
