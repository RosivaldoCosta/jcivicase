...
class seat_types_detailModelseat_types_detail extends JModel
{
	...
	function store($data)
	{
		//DEVNOTE: Load table class from com_rsappt_pro2/tables/seat_types_detail.php	
		$row =& $this->getTable();
