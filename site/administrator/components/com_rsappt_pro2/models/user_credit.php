...
class user_creditModeluser_credit extends JModel
{
	...
	{
		$orderby	= $this->_buildContentOrderBy();
		$query = "SELECT #__sv_apptpro2_user_credit.*, #__users.name ".
		"FROM #__sv_apptpro2_user_credit INNER JOIN #__users ON #__sv_apptpro2_user_credit.user_id = #__users.id ".
		$orderby;
		//echo $query;
		//exit;
