...
class categories_detailController extends JController
{
	...
	*/
	function edit()
	{
		JRequest::setVar( 'view', 'categories_detail' );
	...
	*/
	function save()
	{
		...
		$model->checkin();
		$this->setRedirect( 'index.php?option=com_rsappt_pro2&controller=categories',$msg );
	}
	...
	*/
	function remove()
	{
		...
		if(!$model->delete($cid)) {
			...
			$this->setRedirect( 'index.php?option=com_rsappt_pro2&controller=categories' );
		}
	}
