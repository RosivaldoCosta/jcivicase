...
class reminderlog_detailController extends JController
{
	...
	*/
	function edit()
	{
		JRequest::setVar( 'view', 'reminderlog_detail' );
	...
	*/
	function save()
	{
		...
		$model->checkin();
		$this->setRedirect( 'index.php?option=com_rsappt_pro2&controller=reminderlog',$msg );
	}
	...
	*/
	function remove()
	{
		...
		if(!$model->delete($cid)) {
			...
			$this->setRedirect( 'index.php?option=com_rsappt_pro2&controller=reminderlog' );
		}
	}
	...
	*/
	...
	/** function saveorder
	*
	* saveorder of the reminderlog items
	* 			
	* @param array cid		- array of id
