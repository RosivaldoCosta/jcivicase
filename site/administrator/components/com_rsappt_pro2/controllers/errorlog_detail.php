...
class errorlog_detailController extends JController
{
	...
	*/
	function edit()
	{
		JRequest::setVar( 'view', 'errorlog_detail' );
	...
	*/
	function save()
	{
		...
		$model->checkin();
		$this->setRedirect( 'index.php?option=com_rsappt_pro2&controller=errorlog',$msg );
	}
	...
	*/
	function remove()
	{
		...
		if(!$model->delete($cid)) {
			...
			$this->setRedirect( 'index.php?option=com_rsappt_pro2&controller=errorlog' );
		}
	}
	...
	*/
	...
	/** function saveorder
	*
	* saveorder of the errorlog items
	* 			
	* @param array cid		- array of id
