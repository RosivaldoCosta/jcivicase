...
class udfs_detailController extends JController
{
	...
	*/
	function edit()
	{
		JRequest::setVar( 'view', 'udfs_detail' );
	...
	*/
	function save()
	{
		...
		$model->checkin();
		$this->setRedirect( 'index.php?option=com_rsappt_pro2&controller=udfs',$msg );
	}
	...
	*/
	function remove()
	{
		...
		if(!$model->delete($cid)) {
			...
			$this->setRedirect( 'index.php?option=com_rsappt_pro2&controller=udfs' );
		}
	}
