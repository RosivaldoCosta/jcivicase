...
class coupons_detailController extends JController
{
	...
	*/
	function save()
	{
		...
		$model->checkin();
		$this->setRedirect( 'index.php?option=com_rsappt_pro2&controller=coupons',$msg );
	}
	...
	*/
	function remove()
	{
		...
		if(!$model->delete($cid)) {
			...
			$this->setRedirect( 'index.php?option=com_rsappt_pro2&controller=coupons' );
		}
	}
