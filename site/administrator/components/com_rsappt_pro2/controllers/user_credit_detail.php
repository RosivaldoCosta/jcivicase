...
class user_credit_detailController extends JController
{
	...
	*/
	function edit()
	{
		JRequest::setVar( 'view', 'user_credit_detail' );
	...
	*/
	function save()
	{
		...
		$model->checkin();
		$this->setRedirect( 'index.php?option=com_rsappt_pro2&controller=user_credit',$msg );
	}
	...
	*/
	function remove()
	{
		...
		if(!$model->delete($cid)) {
			...
			$this->setRedirect( 'index.php?option=com_rsappt_pro2&controller=user_credit' );
		}
	}
	...
	*/
	...
	/** function saveorder
	*
	* saveorder of the user_credit items
	* 			
	* @param array cid		- array of id
