...
class seat_types_detailController extends JController
{
	...
	*/
	function edit()
	{
		JRequest::setVar( 'view', 'seat_types_detail' );
	...
	*/
	function save()
	{
		...
		$model->checkin();
		$this->setRedirect( 'index.php?option=com_rsappt_pro2&controller=seat_types',$msg );
	}
	...
	*/
	function remove()
	{
		...
		if(!$model->delete($cid)) {
			...
			$this->setRedirect( 'index.php?option=com_rsappt_pro2&controller=seat_types' );
		}
	}
