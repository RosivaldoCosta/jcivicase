 ...
 */
class config_detailVIEWconfig_detail extends JView
{
	/**
	 * Display the view
	 */
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'RS1_ADMIN_TOOLBAR_CONFIGURE' ), 'configure'  );
		JToolBarHelper::save();
//		if ($isNew)  {
...
//		}
		JToolBarHelper::help( 'screen.rsappt_pro.config', true );    
