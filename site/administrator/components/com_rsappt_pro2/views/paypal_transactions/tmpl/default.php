...
<style type="text/css">
<!--
.icon-48-paypal { background-image: url(./components/com_rsappt_pro2/images/pay.png); }
-->
}
</style>
...
<form action="<?php echo $this->request_url; ?>" method="post" name="adminForm" >
  <table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
	...
	$link 	= JRoute::_( 'index.php?option=com_rsappt_pro2&controller=paypal_transactions_detail&task=edit&cid[]='. $row->id_paypal_transactions );
	$link_to_request = JRoute::_( 'index.php?option=com_rsappt_pro2&controller=requests_detail&task=edit&cid[]='. $row->custom."&frompage=PayPal" );
