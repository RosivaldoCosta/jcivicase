...
class bookoffsViewbookoffs_copy extends JView
{
	/**
	 * Custom Constructor
	 */
	...
	function display($tpl = null)
	{
	    ...
	    JToolBarHelper::title( JText::_('RS1_ADMIN_TOOLBAR_BOOKOFFS_COPY'), '' );
		...
		$bookoffs_tocopy = $mainframe->getUserStateFromRequest( 'bookoffs_tocopy', 'bookoffs_tocopy', $cid );
