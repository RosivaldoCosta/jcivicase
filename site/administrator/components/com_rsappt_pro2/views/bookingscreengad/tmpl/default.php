...
<?php } ?>
    <tr>
      <td class="sv_apptpro_request_label"><?php echo JText::_('RS1_INPUT_SCRN_NAME');?></td>
		...
		<input name="name" type="text" id="name" class="sv_apptpro_request_text"
      		size="40" maxlength="50" title="<?php echo JText::_('RS1_INPUT_SCRN_NAME_TOOLTIP');?>" value="<?php echo $u[$cId]['sort_name']; ?>" readonly='readonly'/>
