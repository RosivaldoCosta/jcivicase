 ...
 */
class extras_detailVIEWextras_detail extends JView
{
	/**
	 * Display the view
	 */
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'RS1_ADMIN_TOOLBAR_EXTRAS_DETAIL' ).': <small><small>[ ' . $text.' ]</small></small>', 'addedit'  );
		JToolBarHelper::save();
		if ($isNew)  {
		...
		JToolBarHelper::help( 'screen.rsappt_pro.extra_edit', true );    
