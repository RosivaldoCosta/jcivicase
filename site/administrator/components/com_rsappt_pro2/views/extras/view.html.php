...
class extrasViewextras extends JView
{
	/**
	 * Custom Constructor
	 */
	...
	function display($tpl = null)
	{
	    ...
	    JToolBarHelper::title(   JText::_( 'RS1_ADMIN_TOOLBAR_EXTRAS' ), 'extras' );
		...
		JToolBarHelper::editListX('edit', JText::_('RS1_ADMIN_TOOLBAR_EXTRAS_EDIT'));
		JToolBarHelper::addNewX('add', JText::_('RS1_ADMIN_TOOLBAR_EXTRAS_NEW'));
		JToolBarHelper::help('screen.rsappt_pro.extras', true);
