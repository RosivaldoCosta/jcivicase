...
class couponsViewcoupons extends JView
{
	...
	function display($tpl = null)
	{
	    ...
	    JToolBarHelper::title(   JText::_( 'RS1_ADMIN_TOOLBAR_COUPONS' ), 'coupon' );
		...
		JToolBarHelper::editListX('edit', JText::_('RS1_ADMIN_TOOLBAR_COUPON_EDIT'));
		JToolBarHelper::addNewX('add', JText::_('RS1_ADMIN_TOOLBAR_COUPON_NEW'));
		JToolBarHelper::help( 'screen.rsappt_pro.coupons', true );    
