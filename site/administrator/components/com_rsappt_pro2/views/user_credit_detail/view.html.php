 ...
 */
class user_credit_detailVIEWuser_credit_detail extends JView
{
	/**
	 * Display the view
	 */
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'RS1_ADMIN_TOOLBAR_CREDIT_DETAIL' ).': <small><small>[ ' . $text.' ]</small></small>', 'addedit'  );
		JToolBarHelper::save();
		if ($isNew)  {
