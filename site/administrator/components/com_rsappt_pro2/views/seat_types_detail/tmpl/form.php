...
<fieldset class="adminform">
  <table border="0" cellpadding="2" cellspacing="0">
    <tr>
      <td colspan="3">
        <p><?php echo JText::_('RS1_ADMIN_SCRN_SEAT_TYPE_DETAIL_INTRO');?><br /><?php echo JText::_('RS1_ADMIN_SEAT_TYPE_INTRO');?><br />
        </p>      </td>
    </tr>
    <tr class="admin_detail_row1">
      <td><?php echo JText::_('RS1_ADMIN_SCRN_SEAT_TYPE_ID');?>:</td>
    ...
    <tr class="admin_detail_row1">
      ...
      <td valign="top"><input type="text" size="50" maxsize="255" name="seat_type_tooltip" id="seat_type_tooltip" value="<?php echo stripslashes($this->detail->seat_type_tooltip); ?>" /></td>
    ...
    <tr class="admin_detail_row0">
      ...
      <td valign="top"><?php echo JText::_('RS1_INPUT_SCRN_CURRENCY_SYMBOL');?>&nbsp;<input type="text" size="5" maxsize="10" name="seat_type_cost" id="seat_type_cost" value="<?php echo stripslashes($this->detail->seat_type_cost); ?>" /></td>
    ...
    <tr class="admin_detail_row1">
      ...
      <td valign="top"><input type="text" size="50" maxsize="255" name="seat_type_help" id="seat_type_help" value="<?php echo stripslashes($this->detail->seat_type_help); ?>" /></td>
    ...
    <tr class="admin_detail_row1">
      ...
      <td valign="top"><input type="text" size="2" maxsize="3" name="seat_group_max" id="seat_group_max" value="<?php echo stripslashes($this->detail->seat_group_max); ?>" /></td>
    ...
    <tr class="admin_detail_row0">
      ...
      <table width="95%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="34%" valign="top" align="center"><input type="button" name="btnAddResource" id="btnAddResource" size="10" value="<?php echo JText::_('RS1_ADMIN_SCRN_SEAT_TYPE_RESOURCES_ADD');?>" onclick="doAddResource()" />
              <br />
              &nbsp;<br />
