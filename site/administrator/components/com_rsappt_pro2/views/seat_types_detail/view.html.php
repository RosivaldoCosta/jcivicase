 ...
 */
class seat_types_detailVIEWseat_types_detail extends JView
{
	/**
	 * Display the view
	 */
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'RS1_ADMIN_TOOLBAR_SEAT_DETAIL' ).': <small><small>[ ' . $text.' ]</small></small>', 'addedit'  );
		JToolBarHelper::save();
		if ($isNew)  {
		...
		JToolBarHelper::help( 'screen.rsappt_pro.seat_edit', true );    
