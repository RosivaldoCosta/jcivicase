...
class timeslotsViewtimeslots extends JView
{
	/**
	 * Custom Constructor
	 */
	...
	function display($tpl = null)
	{
	    ...
	    JToolBarHelper::title(   JText::_( 'RS1_ADMIN_TOOLBAR_TIMESLOTS_LIST' ), 'timeslots' );
    
    	//DEVNOTE: Set toolbar items for the page
		JToolBarHelper::publishList();
		JToolBarHelper::unpublishList();
		JToolBarHelper::customX( 'copy', 'copy.png', 'copy_f2.png', JText::_('RS1_ADMIN_TOOLBAR_TIMESLOTS_COPY'));
		JToolBarHelper::deleteList( JText::_('RS1_ADMIN_TOOLBAR_TIMESLOTS_DEL_CONF'), 'remove', JText::_('RS1_ADMIN_TOOLBAR_TIMESLOTS_DEL') );
		JToolBarHelper::editListX('edit', JText::_('RS1_ADMIN_TOOLBAR_TIMESLOTS_EDIT'));
		JToolBarHelper::addNewX('add', JText::_('RS1_ADMIN_TOOLBAR_TIMESLOTS_NEW'));
		JToolBarHelper::help('screen.rsappt_pro.timeslots', true);
