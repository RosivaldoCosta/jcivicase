...
<style type="text/css">
<!--
.icon-48-timeslots { background-image: url(./components/com_rsappt_pro2/images/timeslots.jpg); }
-->
}
</style>
...
<form action="<?php echo $this->request_url; ?>" method="post" name="adminForm" >
  ...
  <table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
   <thead>
	...
	$link 	= JRoute::_( 'index.php?option=com_rsappt_pro2&controller=timeslots_detail&task=edit&cid[]='. $row->id_timeslots );
	$checked 	= JHTML::_('grid.checkedout', $row, $i, 'id_timeslots');
   ?>
    <tr class="<?php echo "row$k"; ?>">
      <td width="5%" align="center"><input type="checkbox" id="cb<?php echo $i;?>" name="cid[]" value="<?php echo $row->id_timeslots; ?>" onclick="isChecked(this.checked);" /></td>
      <td width="5%" align="center"><a href=<?php echo $link; ?>><?php echo $row->id_timeslots; ?></a></td>
