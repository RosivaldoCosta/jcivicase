...
class backup_restoreViewbackup_restore extends JView
{
	/**
	 * Custom Constructor
	 */
	...
	function display($tpl = null)
	{
	    ...
	    JToolBarHelper::title( JText::_('RS1_ADMIN_TOOLBAR_BACKUP'), 'backup.png' );
    
    	//DEVNOTE: Set toolbar items for the page
		JToolBarHelper::spacer();
		JToolBarHelper::help('screen.rsappt_pro.backup', true);
