...
class servicesViewservices_copy extends JView
{
	/**
	 * Custom Constructor
	 */
	...
	function display($tpl = null)
	{
	    ...
	    JToolBarHelper::title( JText::_('RS1_ADMIN_TOOLBAR_SERVICES_DETAIL_COPY'), '' );
		...
		$services_tocopy = $mainframe->getUserStateFromRequest( 'services_tocopy', 'services_tocopy', $cid );
		$this->assignRef('services_tocopy',	$services_tocopy);
