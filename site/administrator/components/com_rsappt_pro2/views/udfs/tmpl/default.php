...
<style type="text/css">
<!--
.icon-48-udf { background-image: url(./components/com_rsappt_pro2/images/udf.png); }
-->
}
</style>
<table class="adminheading">
  <tr>
    <th><?php echo JText::_('RS1_ADMIN_UDF_LIST');?></th>
  </tr>
</table>
...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
    ...
    <tr>
      ...
      <th class="title" align="center"><?php echo JHTML::_( 'grid.sort', JText::_('RS1_ADMIN_SCRN_ID_COL_HEAD'), 'id_udfs', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
	...
	$link 	= JRoute::_( 'index.php?option=com_rsappt_pro2&controller=udfs_detail&task=edit&cid[]='. $row->id_udfs );
	$checked 	= JHTML::_('grid.checkedout', $row, $i, 'id_udfs');
   ?>
    <tr class="<?php echo "row$k"; ?>">
      <td align="center"><input type="checkbox" id="cb<?php echo $i;?>" name="cid[]" value="<?php echo $row->id_udfs; ?>" onclick="isChecked(this.checked);" /></td>
      <td align="center"><?php echo $row->id_udfs; ?>&nbsp;</td>
      <td><a href=<?php echo $link; ?>><?php echo  stripslashes($row->udf_label); ?></a></td>
      <td align="center"><?php echo $row->udf_type; ?>&nbsp;</td>
      <td align="center"><?php echo ($row->udf_type == "Textbox" || $row->udf_type == "Textarea" || $row->udf_type == "Checkbox" ? $row->udf_required : "--"); ?>&nbsp;</td>
