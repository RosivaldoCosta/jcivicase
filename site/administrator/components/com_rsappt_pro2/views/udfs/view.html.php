...
class udfsViewudfs extends JView
{
	/**
	 * Custom Constructor
	 */
	...
	function display($tpl = null)
	{
	    ...
	    JToolBarHelper::title(   JText::_( 'RS1_ADMIN_TOOLBAR_UDF' ), 'udf' );
		...
		JToolBarHelper::editListX('edit', JText::_('RS1_ADMIN_TOOLBAR_UDF_EDIT'));
		JToolBarHelper::addNewX('add', JText::_('RS1_ADMIN_TOOLBAR_UDF_NEW'));
