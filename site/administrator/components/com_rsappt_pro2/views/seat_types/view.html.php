...
class seat_typesViewseat_types extends JView
{
	/**
	 * Custom Constructor
	 */
	...
	function display($tpl = null)
	{
	    ...
	    JToolBarHelper::title(   JText::_( 'RS1_ADMIN_TOOLBAR_SEATS' ), 'seats' );
		...
		JToolBarHelper::editListX('edit', JText::_('RS1_ADMIN_TOOLBAR_SEAT_EDIT'));
		JToolBarHelper::addNewX('add', JText::_('RS1_ADMIN_TOOLBAR_SEAT_NEW'));
		JToolBarHelper::help('screen.rsappt_pro.seats', true);
