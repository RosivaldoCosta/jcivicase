...
class edit_filesViewedit_files extends JView
{
	/**
	 * Custom Constructor
	 */
	...
	function display($tpl = null)
	{
	    ...
	    JToolBarHelper::title( JText::_('RS1_ADMIN_TOOLBAR_EDIT_FILES'), 'editfiles.png' );
    
    	//DEVNOTE: Set toolbar items for the page
		JToolBarHelper::save('save');
		JToolBarHelper::help('screen.rsappt_pro.css_edit', true);
