...
class servicesViewservices extends JView
{
	...
	function display($tpl = null)
	{
	    ...
	    JToolBarHelper::title(   JText::_( 'RS1_ADMIN_TOOLBAR_SERVICES' ), 'services' );
    
    	//DEVNOTE: Set toolbar items for the page
		JToolBarHelper::publishList();
		JToolBarHelper::unpublishList();
		JToolBarHelper::customX( 'copy', 'copy.png', 'copy_f2.png', JText::_('RS1_ADMIN_TOOLBAR_SERVICES_COPY'));
		JToolBarHelper::deleteList( JText::_('RS1_ADMIN_TOOLBAR_SERVICES_DEL_CONF'), 'remove', JText::_('RS1_ADMIN_TOOLBAR_SERVICES_DEL'));
		JToolBarHelper::editListX('edit', JText::_('RS1_ADMIN_TOOLBAR_SERVICES_EDIT'));
		JToolBarHelper::addNewX('add', JText::_('RS1_ADMIN_TOOLBAR_SERVICES_NEW'));
		JToolBarHelper::help( 'screen.rsappt_pro.services', true );    
