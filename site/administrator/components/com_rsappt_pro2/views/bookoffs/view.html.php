...
class bookoffsViewbookoffs extends JView
{
	/**
	 * Custom Constructor
	 */
	...
	function display($tpl = null)
	{
	    ...
	    JToolBarHelper::title(   JText::_( 'RS1_ADMIN_TOOLBAR_BOOKOFFS' ), 'bookoffs' );
    
    	//DEVNOTE: Set toolbar items for the page
		JToolBarHelper::publishList();
		JToolBarHelper::unpublishList();
		JToolBarHelper::customX( 'copy_bookoffs', 'copy.png', 'copy_f2.png', JText::_('RS1_ADMIN_TOOLBAR_BOOKOFFS_COPY'));
		JToolBarHelper::deleteList( JText::_('RS1_ADMIN_TOOLBAR_BOOKOFFS_DEL_CONF'), 'remove', JText::_('RS1_ADMIN_TOOLBAR_BOOKOFFS_DEL') );
		JToolBarHelper::editListX('edit', JText::_('RS1_ADMIN_TOOLBAR_BOOKOFFS_EDIT'));
		JToolBarHelper::addNewX('add', JText::_('RS1_ADMIN_TOOLBAR_BOOKOFFS_NEW'));
		JToolBarHelper::help( 'screen.rsappt_pro.bookoffs', true );    
