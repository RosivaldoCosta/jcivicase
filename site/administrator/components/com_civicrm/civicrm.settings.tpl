...
/**
 * CiviCRM Configuration File - v{$version}
 */
 ...
 */
define( 'CIVICRM_UF_DSN'           , 'mysql://{$username}:{$pwd}@{$server}/{$db}?new_link=true' );
 ...
 *
 */
define( 'CIVICRM_DSN'          , 'mysql://{$civicrm_db}:{$civicrm_pwd}@{$civicrm_server}/{$civicrm_db}?new_link=true' );
...
$civicrm_root = '{$site_root}/administrator/components/com_civicrm/civicrm';
define( 'CIVICRM_TEMPLATE_COMPILEDIR', '{$site_root}/media/civicrm/templates_c' );
 ...
 */
define( 'CIVICRM_UF_BASEURL'      , 'http://{$site_url}/{$site_name}/administrator/' );
