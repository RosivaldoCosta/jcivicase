...
<table cellpadding="4" cellspacing="0" border="0" width="100%">
	<tr>
		<td width="100%">
			<div style="float:right"><?php echo $this->parents;?></div>
		</td>
	</tr>
</table>
...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
	<tr>
		...
		<th class="title" width="25%" nowrap="nowrap"><?php echo JText::_('JEV_CATEGORY_ADMIN'); ?></th>
		<th width="2%"><?php echo JText::_('JEV_ORDER'); ?></th>
		<th width="1%">
    ...
    foreach ($this->cats as $cat) {
        ...
        <tr class="row<?php echo $k; ?>">
        	<td width="20" style="background-color:<?php echo $cat->getColor();?>">
          	...
          	<td><?php echo $cat->_parent;?></td>
          	<td><?php echo $cat->getAdmin();?></td>
