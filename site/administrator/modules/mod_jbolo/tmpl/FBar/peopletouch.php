...
<?php if (!(in_array('PeopleTouch', $iconsfields)))  { ?>
<div class="jfb_icons">
<span title="<?php echo JText::_('MOD_FB_TOUCHHOME'); ?>">
<a href="<?php echo JRoute::_('index.php?option=com_community&view=profile&Itemid='.$mt); ?>">
<img src="<?php echo JURI::base().'modules/mod_jbolo/images/'.$themename.'/bar-icons/touch'.$imagetype; ?>" alt="<?php echo JText::_('MOD_FB_TOUCHHOME'); ?>" /></a></span> 
</div>
<?php }?>
