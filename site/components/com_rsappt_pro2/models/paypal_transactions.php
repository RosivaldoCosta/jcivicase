...
class adminModelpaypal_transactions extends JModel
{
	...
	function __construct()
	{
		...
		$limit			= $mainframe->getUserStateFromRequest( $context.'pp_limit', 'pp_limit', $mainframe->getCfg('list_limit'), 0);
	...
	function _buildQuery()
	{
		...
		$filter_pp_startdate = $mainframe->getUserStateFromRequest( $context.'filter_pp_startdate', 'filter_pp_startdate', date("Y-m-d") );
