...
class adminModelservices extends JModel
{
	...
	{
		$orderby	= $this->_buildContentOrderBy();
		$query = "SELECT #__sv_apptpro2_services.*, #__sv_apptpro2_resources.name AS res_name ".
		...
		" WHERE resource_id =".$this->getState('filter_service_resource')." ".
		$orderby;
		//echo $query;
		//exit;
