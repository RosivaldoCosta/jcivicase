...
class adminModelresources extends JModel
{
	...
	function _buildQueryForListScreen()
	{
		...
		$query = " SELECT ".
		"#__sv_apptpro2_resources.*, #__sv_apptpro2_categories.name AS ".
		"cat_name, #__sv_apptpro2_categories.id_categories AS cat_id ".
		"FROM ".
		"#__sv_apptpro2_resources LEFT JOIN #__sv_apptpro2_categories ".
		"ON #__sv_apptpro2_resources.category_id = #__sv_apptpro2_categories.id_categories ".	
		"WHERE resource_admins LIKE '%|".$user->id."|%' ".$orderby;
		//echo $query;
		//exit;
