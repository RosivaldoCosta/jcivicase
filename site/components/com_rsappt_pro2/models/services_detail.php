...
class admin_detailModelservices_detail extends JModel
{
	...
	function store($data)
	{
		//DEVNOTE: Load table class from com_rsappt_pro2/tables/services_detail.php	
		$row =& $this->getTable();
		...
		if (!$row->id_services) {
			$where = 'id_services = ' . $row->id_services ;
