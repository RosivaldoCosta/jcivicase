...
//	echo "Version:". substr( $VERSION->getShortVersion(), 0, 3 );
	...
	$fb_name = JRequest::getVar('fb_name','');
	$fb_email = JRequest::getVar('fb_email','');
...
<link href="<?php echo $this->baseurl;?>/components/com_rsappt_pro2/sv_apptpro_fb.css" rel="stylesheet">
          ...
          <table class="sv_gad_container_table" cellpadding="2" cellspacing="0" id="gad_container" style="display:none">
            <tr>
              <td><?php echo JText::_('RS1_GAD_SCRN_DATE');?> <input readonly="readonly" name="grid_date" id="grid_date" type="text" 
                  class="sv_request_text" size="10" maxlength="10" value="<?php echo $grid_date ?>" onchange="changeDate();"/>
...
?>
  ...
  <?php if($apptpro_config->hide_logo == 'No'){ ?>
	  <span class="sv_request_text" style="font-size:9px; color:#999999">powered by <a href="http://www.AppointmentBookingPro.com" target="_blank">AppointmentBookingPro.com</a> v 2.0</span>
  <?php } ?>
