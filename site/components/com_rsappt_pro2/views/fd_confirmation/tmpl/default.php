...
JHTML::_('behavior.tooltip');
	...
	$message = buildMessage($req_id, "confirmation", "No");
...
<link href="../components/com_rsappt_pro2/sv_apptpro.css" rel="stylesheet">
	...
	<p>
    <a href=# onclick="do_continue()"><?php echo JText::_('RS1_FD_CONFIRMATION_CONTINUE');?></a>
    </p>

	<p>
    <a href=# onclick="do_book_another()"><?php echo JText::_('RS1_FD_CONFIRMATION_BOOK_ANOTHER');?></a>
    </p>
