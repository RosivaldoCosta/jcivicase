...
//	require_once( JPATH_SITE."/components/com_rsappt_pro2/functions2.php" );
	...
	if($session->get("filter_order") != "" ){
		...
		$filter_order = JRequest::getVar( 'filter_order', 'startdate' );
	}
...
//			$sql = $sql."#__sv_apptpro2_requests.user_id = ".$user->id.
			$sql = $sql."#__sv_apptpro2_requests.email = '".$fb_email."'".
...
<link href="./components/com_rsappt_pro2/sv_apptpro_fb.css" rel="stylesheet">
