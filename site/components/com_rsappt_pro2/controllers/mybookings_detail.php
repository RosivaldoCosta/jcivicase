...
class mybookings_detailController extends JController
{
	...
	*/
	function edit()
	{
		JRequest::setVar( 'view', 'mybookings_detail' );
		...
		// Checkin the mybookings
		$model = $this->getModel('mybookings_detail');
		$model->checkout();
	}
	...
	*/
	function remove()
	{
		...
		if(!$model->delete($cid)) {
			...
			$this->setRedirect( 'index.php?option=com_rsappt_pro2&controller=mybookings' );
		}
	}
	...
	*/
	...
	/** function saveorder
	*
	* saveorder of the mybookings items
	* 			
	* @param array cid		- array of id
