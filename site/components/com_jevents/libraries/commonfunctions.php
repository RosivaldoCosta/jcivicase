 ...
 *
 * @version     $Id: commonfunctions.php 1126 2008-08-02 16:54:20Z tstahl $
 * @package     JEvents
 ...
 */
	...
	function hasAdvancedRowPermissions($row,$user=null){
		...
		if( JEVHelper::isEventEditor() || JEVHelper::isEventPublisher()){
			return true;
		} 
	...
	function sendAdminMail( $adminName, $adminEmail, $subject='', $title='', $content='', $author='', $live_site, $modifylink ) {
		...
		$content .= $lf . sprintf( JText::_('JEV_MANAGE_EVENTS'), $adminLink);
