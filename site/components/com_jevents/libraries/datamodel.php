 ...
 *
 * @version     $Id: datamodel.php 1148 2008-08-19 16:56:37Z tstahl $
 * @package     JEvents
...
class JEventsDataModel {
	...
	function getEventData( $evid, $jevtype, $year, $month, $day, $uid="" ) {
		$data = array();
		...
		$row = $this->queryModel->listEventsById ($evid, 1, $jevtype);  // include unpublished events for publishers and above
	...
	function getDataForAdmin( $creator_id, $limit, $limitstart ){
		...
		$total = $this->queryModel->countEventsByCreator ($creator_id);
