	...
	if( (JEVHelper::canEditEvent($row) || JEVHelper::canPublishEvent($row)|| JEVHelper::canDeleteEvent($row))  && !( $mask & MASK_POPUP )) {
		...
		if (JEVHelper::canPublishEvent($row)){
            ...
            <div id="action_dialog"  style="position:absolute;right:0px;background-color:#dedede;border:solid 1px #000000;width:200px;padding:10px;visibility:hidden;z-index:999;">
            	...
            	<a href="<?php echo $editCopyLink;?>" id="edit_event" title="edit event" style="text-decoration:none;"><img src="<?php echo $editCopyImg; ?>" style="width:20px;height:20px;border:0px;margin-right:1em;" alt="" /><?php echo JText::_("Copy and Edit Event");?></a><br/>
                 <?php
                 if ($deleteRepeatLink!=""){
                 ?>
                 <a href="<?php echo $deleteRepeatLink;?>" onclick="return confirm('Are you sure you want to delete this recurrence?')" id="delete_repeat"  title="delete repeat" style="text-decoration:none;"><img src="<?php echo $deleteRepeatImg; ?>"  style="width:20px;height:20px;border:0px;margin-right:1em;" alt="" /><?php echo JText::_("Delete This Repeat");?></a><br/>
                 <?php
                 }
                 if ($deleteLink!=""){
                 ?>
                 <a href="<?php echo $deleteLink;?>" onclick="return confirm('Are you sure you wish to delete this event and all its repeat?')" id="delete_event"  title="delete event" style="text-decoration:none;"><img src="<?php echo $deleteImg; ?>"  style="width:20px;height:20px;border:0px;margin-right:1em;" alt="" /><?php echo JText::_("Delete All Repeats");?></a><br/>
            	<?php
                 }
                 if ($deleteFutureLink!=""){
                 ?>
                 <a href="<?php echo $deleteFutureLink;?>" onclick="return confirm('Are you sure you with to delete this event and all future repeats?')" id="delete_event"  title="delete event" style="text-decoration:none;"><img src="<?php echo $deleteFutureImg; ?>"  style="width:20px;height:20px;border:0px;margin-right:1em;" alt="" /><?php echo JText::_("Delete Future Repeats");?></a><br/>
            <?php
