...
if (is_null($this->data)){
	global $mainframe;
	$mainframe->redirect(JRoute::_("index.php?option=$option&Itemid=$this->Itemid",false), "Sorry - This item may have been updated while you have been viewing the webpage.  Please try again");
}
                    ...
                    <td  width="20" class="buttonheading" align="right">
						...
						if ($cfg->get('jev_debug', 0)) {
							...
							if ($jevtype=="jevent"){
								...
								$row->vCalExportLink(),
								'<img src="'. JURI::root() . 'components/'.JEV_COM_COMPONENT.'/images/vcal.gif" align="middle" alt="vCalendar export" border="0" />',
								...
								<a href="javascript:void(0)" onclick='clickIcalButton()' title="<?php echo JText::_('JEV_E_EDIT');?>">
									<img src="<?php echo JURI::root().'components/'.JEV_COM_COMPONENT.'/images/vcal.gif'?>" align="middle" name="image"  alt="<?php echo JText::_('JEV_E_EDIT');?>" />
								</a>
								<?php
							}
						} ?>
