 ...
 *
 * @version     $Id: router.php 1117 2008-07-06 17:20:59Z tstahl $
 * @package     JEvents
		...
		case "admin.listevents":
			{
				...
				$year	= intval( JRequest::getVar( 'year',	strftime( '%Y', $t_datenow->toUnix(true)) ));
				$month	= intval( JRequest::getVar( 'month',	strftime( '%m', $t_datenow->toUnix(true)) ));
				$day	= intval( JRequest::getVar( 'day',	strftime( '%d', $t_datenow->toUnix(true)) ));
