    ...
    <?php endif; ?>
     ...
     <?php ifif $event.is_public  ?>
	  ...
	  //need to do
         ...
         <a href="{$icalFile}">&raquo; JText::_('Download iCalendar File')</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="{$icalFeed}" title="JText::_('iCalendar Feed')"><img src="{$config->resourceBase}ical_feed.gif" alt="JText::_('iCalendar Feed')" /></a> 
      </div>
    <?php endif; ?>
</div>
