...
class JboloController extends JController
{
	...
	// Settings
		$save_path = JPATH_SITE."/components/com_jbolo/uploads/";		// The path were we will save the file (getcwd() may not be reliable and should be tested in your environment)
...
EOD;
	...
	{
		require(JPATH_COMPONENT.DS."config".DS."config.php");
		$uploaddir = JPATH_COMPONENT.DS."uploads".DS;
