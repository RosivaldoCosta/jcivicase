...
class CRM_Contact_Form_Search_Custom_FrequentCallers
  ...
  implements CRM_Contact_Form_Search_Interface {
	...
	// parameter autoclick for search
        $form->_autoclick = CRM_Utils_Array::value( 'c', $_GET );
        if($form->_autoclick)
        {
            $form->assign('autoclick',$form->_autoclick);
        }

        $contactTypes = array( 'Individual' => 'Clients' ); // + CRM_Contact_BAO_ContactType::getSelectElements( );
	...
	*/
        ...
        $tag =
            array('6' => ts('Frequent Callers')); // + CRM_Core_PseudoConstant::tag( );
