...
class CRM_Contact_Form_NewContact
{
    function buildQuickForm( &$form ) {
        ...
        $form->add('text', "contact", ts('Client Profile'), $attributes );
        if(isset($form->_currentlyViewedContactId))
		{
		    $form->addElement('hidden', "contact_select_id", $form->_currentlyViewedContactId);
		}
		else
		{
        ...
        if ( CRM_Core_Permission::check( 'edit all contacts' ) ||
            ...
            $form->add( 'select', 'profiles', ts('Create New Client'),
                        array( '' => ts('- create new client -') ) + $contactProfiles,
