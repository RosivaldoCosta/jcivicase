...
class CRM_Report_Form_Case_MCT extends CRM_Report_Form_Case_CaseReportBase {
	...
	*/
	...
	$views = parent::_buildViewList('views_mct_report'); //,'county');
    if (isset($views['view_mct_coupon']))
    {
        $views['view_mct_coupon']['TTL'] = array_sum($views['view_mct_coupon'])-$views['view_mct_coupon']['TTL']-$views['view_mct_coupon']['AVG'];
    }
