...
class CRM_Report_Form_Case_ClientLinkage extends CRM_Report_Form_Case_CaseReportBase {
	...
	/*
        ...
        $this->_columns = 
            array( 'civicrm_contact' =>
				...
				'status_id'   => array( 'title'      => ts( 'Activity Status' ),
                                                      'default'    => false ,
	...
	function buildTable()
    	{
        	$rows = array();
		$totals = array();
        	$views = CRM_Core_OptionGroup::values('views_client_linkage_report');// $activity_name, 'name' );

        	foreach($views as $view => $label)
        	{
                	$rows[$view] = parent::_getView($view, 'Linkage');
			$totals[$view] = parent::_getView($view.'_totals');
