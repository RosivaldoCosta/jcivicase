...
class CRM_Report_Form_Case_Vouchers extends CRM_Report_Form_Case_CaseReportBase 
{

    function __construct( ) {		        
	parent::__construct( );
	parent::getCustomFieldColumns($this->_columns,'Pharmacy Voucher');
	parent::getCustomFieldColumns($this->_columns,'Temporary Housing');
	parent::getCustomFieldColumns($this->_columns,'Motel Voucher');
	parent::getCustomFieldColumns($this->_columns,'Transportation Voucher');
    }
	...
	//$this->buildTable();
	$views = parent::_buildViewList('views_vouchers_report');
