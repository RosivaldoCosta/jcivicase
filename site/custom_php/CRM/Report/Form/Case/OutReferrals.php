...
class CRM_Report_Form_Case_OutReferrals extends CRM_Report_Form_Case_CaseReportBase {
	...
	*/
	...
	$views = parent::_buildViewList('views_out_referrals_report',null,'Referral');
