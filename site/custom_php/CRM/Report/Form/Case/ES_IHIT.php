...
class CRM_Report_Form_Case_ES_IHIT extends CRM_Report_Form_Case_CaseReportBase {
	...
	//$this->buildTable();
	$views = parent::_buildViewList('views_es_ihit_report');
    ...
    {
	$rows = array();
	$views = CRM_Core_OptionGroup::values('views_veteran_report');// $activity_name, 'name' );
