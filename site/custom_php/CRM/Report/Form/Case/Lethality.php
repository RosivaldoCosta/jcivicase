...
class CRM_Report_Form_Case_Lethality extends CRM_Report_Form_Case_CaseReportBase {
	...
	parent::getCustomFieldColumns($this->_columns,'Lethality');
	...
	*/
	...
	$views = parent::_buildViewList('views_lethality_report');
