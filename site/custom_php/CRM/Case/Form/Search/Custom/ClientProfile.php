...
class CRM_Case_Form_Search_Custom_ClientProfile
   ...
   implements CRM_Contact_Form_Search_Interface {
    ...
    function buildForm( &$form ) {
        ...
        $form->addElement( 'text',
                    ...
                    ts( 'Case Number' ),
                    true );
	$form->addRule( 'case_id', ts( 'Please enter a valid case number.' ), 'integer' );
	...
	*/
	...
	$form->addDate( 'start_date', ts('Date of Birth'), false, array( 'formatType' => 'birth') );
         ...
         */
        $form->assign( 'elements', array( 'case_id', 'sort_name','address','phone','start_date' ) );
    }

    function summary( ) {
        $summary = array( 'summary' => 'If you don\'t find a match, click new caller.', 'total' => "" );
        return $summary;
    }
...
LEFT JOIN civicrm_case c ON c.id = cc.case_id and c.is_deleted=0
...
";
     ...
     */
    function addRules( ) {
        $this->addFormRule( array( 'CRM_Case_Form_Search_Custom_ClientProfile', 'formRule' ) );
    }
	...
	if (isset($fields['case_id']) && !empty($fields['case_id']) && !((int)$fields['case_id']))
	{
		$errors['case_id'] = ts('Please enter valid integer value');
	}
