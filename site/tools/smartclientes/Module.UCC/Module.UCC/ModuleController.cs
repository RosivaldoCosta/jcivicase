...
using Sante.EMR.SmartClient.Module.UCC.Constants;
using Sante.EMR.SmartClient.Module.UCC.Properties;


namespace Sante.EMR.SmartClient.Module.UCC
{	
	public class ModuleController : WorkItemController
	{
        ...
        {
            this.RegisterLaunchPoint(CommandNames.QueryUCC, Properties.Resources.UCCIcon, Properties.Resources.ModuleTitle);
        }

        [CommandHandler(CommandNames.QueryUCC)]
        public void OnQueryUCC(object sender, EventArgs e)
        {
            MessageBox.Show("Query UCC invoked");
        }
