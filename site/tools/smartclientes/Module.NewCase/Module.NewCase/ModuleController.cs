...
using Sante.EMR.SmartClient.Module.NewCase.Constants;
...
namespace Sante.EMR.SmartClient.Module.NewCase
{
    public class ModuleController : WorkItemController
    {
        ...
        {
            ToolStripMenuItem item = new ToolStripMenuItem(CommandNames.NewCase);
            WorkItem.Commands[CommandNames.NewCase].AddInvoker(item, "Click");

            WorkItem.UIExtensionSites[UIExtensionSiteNames.NewMenu].Add(item);

        }

        [CommandHandler(CommandNames.NewCase)]
        public void OnRefreshData(object sender, EventArgs e)
        {
            //MessageBox.Show("New Case invoked");
            ShowViewInWorkspace<NewCaseView>(WorkspaceNames.PrimaryWorkspace);
