...
namespace Sante.EMR.SmartClient.Infrastructure.Webserver.Controllers
{
    public class PageController : ApplicationController
    {
        ...
        /// </summary>
        public PageController(TemplateManager mgr, LanguageNode modelLanguage) : base(mgr, modelLanguage)
        {
            DefaultMethod = "Main";
        }
        ...
        public PageController(ViewController controller) : base(controller)
        {
        }
