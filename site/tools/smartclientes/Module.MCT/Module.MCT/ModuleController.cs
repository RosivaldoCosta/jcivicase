...
using Sante.EMR.SmartClient.Module.MCT.Constants;
...
namespace Sante.EMR.SmartClient.Module.MCT
{
    public class ModuleController : WorkItemController
    {
        ...
        {
            this.RegisterLaunchPoint(CommandNames.QueryMCT, Properties.Resources.MCTIcon, Properties.Resources.ModuleTitle);
        }

        [CommandHandler(CommandNames.QueryMCT)]
        public void OnQueryMCT(object sender, EventArgs e)
        {
            //MessageBox.Show("Query MCTinvoked");
