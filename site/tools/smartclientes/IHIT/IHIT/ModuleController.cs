...
using Sante.EMR.SmartClient.IHIT.Constants;
using Sante.EMR.SmartClient.IHIT.Properties;
...
namespace Sante.EMR.SmartClient.IHIT
{
    public class ModuleController : WorkItemController
    {
        ...
        {
            this.RegisterLaunchPoint(Properties.Resources.ModuleTitle, Properties.Resources.IHITIcon, CommandNames.IHITFormSelection);
        }
        ...
        [CommandHandler(CommandNames.IHITFormSelection)]
        public void OnIHITFormSelection(object sender, EventArgs e)
        {
            
            ShowViewInWorkspace<IHITView>(WorkspaceNames.PrimaryWorkspace);
        ...
        [EventSubscription(EventTopicNames.ShowIndividualTreatmentForm, ThreadOption.UserInterface)]
        public void OnShowIndividualTreatmentForm(object sender, EventArgs eventArgs)
        {//TODO: Add your code here
            ShowViewInWorkspace<IHITIndividualTreatmentView>(WorkspaceNames.ModalWindows);
        }
