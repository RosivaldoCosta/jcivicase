...
{
    public class PatientRestTranslator : EntityMapperTranslator<BusinessEntitiesAlias.Patient, String>
    {

        protected override String BusinessToService(IEntityTranslatorService service, BusinessEntitiesAlias.Patient value)
        {
            String v = "";
            ...
            v += "&first_name=" + value.PFirstName;
            v += "&last_name=" + value.PLastName;
            v += "&contact_type=Individual&contact_sub_type=Client";
            return v;
        }
        ...
        /// <returns></returns>
        protected override BusinessEntitiesAlias.Patient ServiceToBusiness(IEntityTranslatorService service, String value)
        { 
