...
namespace Sante.EMR.SmartClient.Infrastructure.Interface.BusinessEntities
{
    ...
    private string _tactile;//[tactile] [varchar](5) null,
        ...
        private string _presentingproblems;
        private string _axis1second;
        private string _axis1third;
        private string _axis1fourth;
        private string _axis2first;
        private string _axis2second;
        private string _axis3first;
        private string _axis3second;
        private string _axis3third;
        private string _axis3fourth;
        private string _axis4primary;
        private string _axis4social;
        private string _axis4educational;
        private string _axis4occupational;
        private string _axis4housing;
        private string _axis4economic;
        private string _axis4access;
        private string _axis4legal;
        private string _axis5current;
        private string _axis5past;
        private string _axis1fifth;
        private string _axis1first;
        private string _circomments;
        private string _interventions;
        private string _med1;
        private string _aircomments;
        ...
        {
            get { return _presentingproblems; }
            set { _presentingproblems = value; }
        }


        public string axis1second
        {
            get { return _axis1second; }
            set { _axis1second = value; }
        }


        public string axis1third
        {
            get { return _axis1third; }
            set { _axis1third = value; }
        }


        public string axis1fourth
        {
            get { return _axis1fourth; }
            set { _axis1fourth = value; }
        }


        public string axis2first
        {
            get { return _axis2first; }
            set { _axis2first = value; }
        }


        public string axis2second
        {
            get { return _axis2second; }
            set { _axis2second = value; }
        }


        public string axis3first
        {
            get { return _axis3first; }
            set { _axis3first = value; }
        }


        public string axis3second
        {
            get { return _axis3second; }
            set { _axis3second = value; }
        }


        public string axis3third
        {
            get { return _axis3third; }
            set { _axis3third = value; }
        }


        public string axis3fourth
        {
            get { return _axis3fourth; }
            set { _axis3fourth = value; }
        }


        public string axis4primary
        {
            get { return _axis4primary; }
            set { _axis4primary = value; }
        }


        public string axis4social
        {
            get { return _axis4social; }
            set { _axis4social = value; }
        }


        public string axis4educational
        {
            get { return _axis4educational; }
            set { _axis4educational = value; }
        }


        public string axis4occupational
        {
            get { return _axis4occupational; }
            set { _axis4occupational = value; }
        }


        public string axis4housing
        {
            get { return _axis4housing; }
            set { _axis4housing = value; }
        }


        public string axis4economic
        {
            get { return _axis4economic; }
            set { _axis4economic = value; }
        }


        public string axis4access
        {
            get { return _axis4access; }
            set { _axis4access = value; }
        }


        public string axis4legal
        {
            get { return _axis4legal; }
            set { _axis4legal = value; }
        }


        public string axis5current
        {
            get { return _axis5current; }
            set { _axis5current = value; }
        }


        public string axis5past
        {
            get { return _axis5past; }
            set { _axis5past = value; }
        }


        public string axis1fifth
        {
            get { return _axis1fifth; }
            set { _axis1fifth = value; }
        }


        public string axis1first
        {
            get { return _axis1first; }
            set { _axis1first = value; }
        }


        public string circomments
        {
            get { return _circomments; }
            set { _circomments = value; }
        }
        ...
        public string aircomments
        {
            get { return _aircomments; }
            set { _aircomments = value; }
        }
