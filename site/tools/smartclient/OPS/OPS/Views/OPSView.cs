...
namespace Sante.EMR.SmartClient.OPS
{
    public partial class OPSView : UserControl, IOPSView, ISmartPartInfoProvider
    {
        ...
        private void AssesTreatmentButton_Click(object sender, EventArgs e)
        {
            if (appver == "ESCRS")
            {
                _presenter.ShowNewIntakeESForm();
            }
            else if (appver == "PGCRS")
            {
                _presenter.ShowNewIntakePGForm();
            }
            else
            {
        ...
        private void OPSTelephoneContact_Click(object sender, EventArgs e)
        {
            _presenter.ShowNewContactForm();
        }
