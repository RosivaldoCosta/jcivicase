...
namespace Sante.EMR.SmartClient.MCT
{
    public class ModuleController : WorkItemController
    {
        ...
        [EventSubscription(EventTopicNames.ShowNewAssessmentTreatmentUCC, ThreadOption.UserInterface)]
        public void OnShowNewAssessmentTreatmentUCC(object sender, EventArgs eventArgs)
        {//TODO: Add your code here
            ShowViewInWorkspace<NewAssessmentTreatmentUCCView>(WorkspaceNames.ModalWindows);
        }
        ...
        [EventSubscription(EventTopicNames.ShowNewMCTDispatchES, ThreadOption.UserInterface)]
        public void OnShowMCTDispatchES(object sender, EventArgs eventArgs)
        {//TODO: Add your code here
            ShowViewInWorkspace<MCTDispatchViewES>(WorkspaceNames.ModalWindows);
        }

        [EventSubscription(EventTopicNames.ShowNewMCTDispatchAA, ThreadOption.UserInterface)]
        public void OnShowMCTDispatchAA(object sender, EventArgs eventArgs)
        {//TODO: Add your code here
            ShowViewInWorkspace<MCTDispatchAAView>(WorkspaceNames.ModalWindows);
        }

        [EventSubscription(EventTopicNames.ShowNewMCTDispatchPG, ThreadOption.UserInterface)]
        public void OnShowMCTDispatchPG(object sender, EventArgs eventArgs)
        {//TODO: Add your code here
            ShowViewInWorkspace<MCTDispatchPGView>(WorkspaceNames.ModalWindows);
        }
