...
using Sante.EMR.SmartClient.Module.OPS.Constants;
...
namespace Sante.EMR.SmartClient.Module.OPS
{
    public class ModuleController : WorkItemController
    {
        ...
        {
            this.RegisterLaunchPoint(CommandNames.QueryOPS, Properties.Resources.OPSIcon, Properties.Resources.ModuleTitle);
        }

        [CommandHandler(CommandNames.QueryOPS)]
        public void OnQueryOPS(object sender, EventArgs e)
        {
            //MessageBox.Show("Query OPS invoked");
