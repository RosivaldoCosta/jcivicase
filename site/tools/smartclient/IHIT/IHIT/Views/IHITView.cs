...
{
    public partial class IHITView : UserControl, IIHITView, ISmartPartInfoProvider
    {
        public IHITView()
        {
            InitializeComponent();
        ...
        private void IHITView_Load(object sender, EventArgs e)
        {
        ...
        {
            _presenter.ShowForm(EventTopicNames.ShowNotesForm);
        }
        ...
        {
            _presenter.ShowForm(EventTopicNames.ShowTelephoneContact);
        }

        private void LethalityButton_Click(object sender, EventArgs e)
        {
            _presenter.ShowForm(EventTopicNames.ShowIndividualTreatmentForm);
        }
