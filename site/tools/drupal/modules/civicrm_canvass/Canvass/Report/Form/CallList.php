...
require_once 'Canvass/Report/Form/List.php';

/**
 *  Generate a phone call list report
 */
class Canvass_Report_Form_CallList extends Canvass_Report_Form_List {
    ...
    function alterDisplay( &$rows ) {
        ...
        foreach ( $rows as $rowNum => $row ) { 
            ...
            // Handle contactType
            if ( !empty( $row[ $this->_demoTable . '_' . $this->_coreTypeCol] ) ) {
                $rows[$rowNum][$this->_demoTable . '_' . $this->_coreTypeCol] =
                    $this->type2str( $rows[$rowNum][$this->_demoTable . '_' . $this->_coreTypeCol] );
                $entryFound = true;
            }
