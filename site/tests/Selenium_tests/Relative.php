...
class Relative extends PHPUnit_Extensions_SeleniumTestCase
{
  ...
  public function testcharlik()
    {
        ...
        $this->click("link=Relative");
        $this->waitForElementPresent("custom_195_-1");
        sleep(2);
        $this->click("custom_195_-1");
        $this->type("custom_195_-1", 'test comment');
        ...
        $this->waitForElementPresent("//*[contains (@id, 'custom_195')]");

             try
                {
                  sleep(10);

                $this->assertEquals("test comment", $this->getValue("//*[contains (@id, 'custom_195')]"));
        sleep(10);
                }
        ...
        $this->waitForElementPresent("//*/table[@id='activities-selector']/*/tr[1]/td[8]/div/a[1]");
        $this->click("//*/table[@id='activities-selector']/*/tr[1]/td[8]/div/a[1]");
        $this->waitForElementPresent("//*[contains (@name, 'custom_195')]");
        $this->waitForElementPresent("//*[contains(@id, 'custom_195')]");
        $this->type("//*[contains(@id, 'custom_195')]", 'test123');
        ...
        $this->waitForElementPresent("//*[contains (@name, 'custom_195')]");
             try
                ...
                $this->assertEquals("test123", $this->getValue("//*[contains (@id, 'custom_195')]"));
