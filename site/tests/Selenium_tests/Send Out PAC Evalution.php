...
class Send_Out_PAC_Evalution extends PHPUnit_Extensions_SeleniumTestCase
{
  ...
  public function testcharlik()
    {
        ...
        $this->click("link=Send Out PAC Evaluation");

        $this->waitForElementPresent("custom_201_-1");
        sleep(2);
        $this->click("custom_201_-1");
        $this->type("custom_201_-1", 'test comment');
        ...
        $this->waitForElementPresent("//*[contains (@id, 'custom_201')]");

             try
                {
                  sleep(10);

                $this->assertEquals("test comment", $this->getValue("//*[contains (@id, 'custom_201')]"));
        sleep(10);
                }
        ...
        $this->waitForElementPresent("//*[contains(@id, 'custom_201')]");
        $this->type("//*[contains(@id, 'custom_201')]", 'test123');
        ...
        $this->waitForElementPresent("//*/table[@id='activities-selector']/*/tr[1]/td[8]/div/a[1]");
        $this->click("//*/table[@id='activities-selector']/*/tr[1]/td[8]/div/a[1]");
        $this->waitForElementPresent("//*[contains (@name, 'custom_201')]");
             try
                    {

                $this->assertEquals("test123", $this->getValue("//*[contains (@id, 'custom_201')]"));
