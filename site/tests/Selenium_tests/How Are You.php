...
class How_Are_You extends PHPUnit_Extensions_SeleniumTestCase
{
  ...
  public function testcharlik()
    {
        ...
        $this->click("link=How Are You");
        $this->waitForElementPresent("custom_177_-1");
        sleep(2);
        $this->click("custom_177_-1");
        $this->type("custom_177_-1", 'test comment');
        ...
        $this->waitForElementPresent("//*[contains (@id, 'custom_177')]");

             try
                {
                  sleep(10);

                $this->assertEquals("test comment", $this->getValue("//*[contains (@id, 'custom_177')]"));
        sleep(10);
                }
        ...
        $this->waitForElementPresent("//*/table[@id='activities-selector']/*/tr[1]/td[8]/div/a[1]");
        $this->click("//*/table[@id='activities-selector']/*/tr[1]/td[8]/div/a[1]");
        $this->waitForElementPresent("//*[contains (@name, 'custom_177')]");
        $this->waitForElementPresent("//*[contains(@id, 'custom_177')]");
        $this->type("//*[contains(@id, 'custom_177')]", 'test123');
        ...
        $this->waitForElementPresent("//*[contains (@name, 'custom_177')]");
             ...
             try
                ...
                $this->assertEquals("test123", $this->getValue("//*[contains (@id, 'custom_177')]"));
