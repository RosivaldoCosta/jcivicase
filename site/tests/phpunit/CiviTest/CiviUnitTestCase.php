 ...
 *   @version   $Id: CiviUnitTestCase.php 25523 2009-12-14 23:42:16Z mover $
 *   @package   CiviCRM
 *
...
class CiviUnitTestCase extends PHPUnit_Extensions_Database_TestCase {
    ...
    protected function getConnection()
    {
        if ( !self::$dbInit ) {
            ...
            self::$utils = new Utils( '192.168.100.241',
                                'civicrm_tester',
                                '23wesdxc@#WESDXC' );
            ...
            $sql_file = dirname( dirname( dirname( dirname( __FILE__ ) ) ) )
                .$joomla_path. "/administrator/components/com_civicrm/civicrm/sql/civicrm.mysql";
