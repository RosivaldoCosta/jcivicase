...
class plgCivicrmPrivacypracticespdf extends JPlugin
{
...
//echo '<pre>'; print_r($form); die;
	if (isset($form->_activityTypeId) && $form->_activityTypeId == 84 && $formName == 'CRM_Case_Form_Activity' && (CRM_Utils_Array::value( 'snippet', $_GET ) == 3 ))
	{
	    // PDF view rule
...
//echo '<pre>' . print_r($form->embedAttachmentTags,true) . '</pre>';
	ActivityPDFHelper::buildForm_signature_add('Privacy_Statement',false,'client',$form, $groupTreeIdx);
	ActivityPDFHelper::buildForm_signature_add('Privacy_Statement',false,'staff',$form, $groupTreeIdx);
	ActivityPDFHelper::buildForm_signature_add('Privacy_Statement',false,'witness',$form, $groupTreeIdx);
	ActivityPDFHelper::buildForm_signature_add('Privacy_Statement',false,'physician',$form, $groupTreeIdx);
