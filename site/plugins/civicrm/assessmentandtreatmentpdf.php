...
class plgCivicrmAssessmentandtreatmentpdf extends JPlugin
{

    function plgCivicrmAssessmentandtreatmentpdf(& $subject, $config)
    {
	parent::__construct($subject, $config);

	// load plugin parameters
	$this->_plugin = JPluginHelper::getPlugin( 'civicrm', 'assessmentandtreatmentpdf' );
...
//echo '<pre>'; print_r($form); die;
	if (isset($form->_activityTypeId) && $form->_activityTypeId == 102 && $formName == 'CRM_Case_Form_Activity' && (CRM_Utils_Array::value( 'snippet', $_GET ) == 3 ))
	{
