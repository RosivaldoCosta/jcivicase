...
<link rel="Shortcut Icon" type="image/x-icon" href="{$config->resourceBase}favicon.png" />
...
<link rel="stylesheet" href="{$config->resourceBase}/civicrm-mini.css" type="text/css" />
{/if}
...
<table border="0" cellpadding="0" cellspacing="0" id="content">
  <tr>
    ...
    <div class="breadcrumb">
      ...
      <div id="printer-friendly"><a href="javascript:window.print()" title="{ts}Print this page.{/ts}"><img src="{$config->resourceBase}print-icon.png" alt="{ts}Print this page.{/ts}" /></a></div>
      {else}
      {* Printer friendly link/icon. *}
      <div id="printer-friendly"><a href="{$printerFriendly}" title="{ts}Printer-friendly view of this page.{/ts}"><img src="{$config->resourceBase}print-icon.png" alt="{ts}Printer-friendly view of this page.{/ts}" /></a></div>
      {/if}
