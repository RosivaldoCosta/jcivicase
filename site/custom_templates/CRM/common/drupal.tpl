...
<a href="{$printerFriendly}" title="{ts}Printer-friendly view of this page.{/ts}"><img src="{$config->resourceBase}print-icon.png" alt="{ts}Printer-friendly view of this page.{/ts}" /></a>
</div>
{/if}
