...
<head>
  ...
  <style type="text/css" media="screen, print">@import url({$config->resourceBase}civicrm.cdn.css);</style>
  <style type="text/css" media="screen, print">@import url({$config->resourceBase}extras.css);</style>
  <style type="text/css" media="print">@import url({$config->resourceBase}print.css);</style>
  <style type="text/css">@import url({$config->resourceBase}theme.css);</style>
  <script type="text/javascript" src="{$config->resourceBase}Common.js"></script>
</head>
