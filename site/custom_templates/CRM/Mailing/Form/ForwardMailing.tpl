...
<div id="comment" style="display:none">
        <div class="form-item">
            ...
            <tr><td><a href="#" onclick="hide('comment'); show('comment_show'); return false;"><img src="{$config->resourceBase}TreeMinus.gif" class="action-icon" alt="{ts}close section{/ts}"/></a></a>
