...
<dl class="html-adjust">
 ...
 <div class="spacer"></div> 	 
  <dt>{$form.is_active.label}</dt><dd>{$form.is_active.html}</dd>
	...
	<div class="spacer"></div>  
        <a href="#" onclick="hide('time-delimited[show]'); show('time-delimited'); return false;"><img src="{$config->resourceBase}TreePlus.gif" class="action-icon" alt="{ts}open section{/ts}"/></a><label>{ts}Subscription or Service Settings{/ts}</label><br />
	</div>	
	<div id="time-delimited"> 
	<div class="spacer"></div>  
    <fieldset><legend><a href="#" onclick="hide('time-delimited'); show('time-delimited[show]'); return false;"><img src="{$config->resourceBase}TreeMinus.gif" class="action-icon" alt="{ts}close section{/ts}"/></a>{ts}Subscription or Service Settings{/ts}</legend>
  <dl>
