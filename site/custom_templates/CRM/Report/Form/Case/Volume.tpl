{include file="CRM/Report/Form/Case/Table.tpl" title="Volume of Service YTD Report"}
<!--
{if $results}
<TABLE FRAME=VOID CELLSPACING=0 COLS=27 RULES=NONE BORDER=0> 
	...
	<TBODY> 
		<TR> 
			<TD COLSPAN=27 WIDTH=889 HEIGHT=28 ALIGN=CENTER VALIGN=TOP><B><FONT SIZE=4 COLOR="#800000">Volume of Service Report</FONT></B></TD> 
		</TR> 
		<TR> 
			<TD STYLE="border-top: 3px solid #000000; border-bottom: 3px solid #000000; border-left: 3px solid #000000; border-right: 3px solid #000000" HEIGHT=28 ALIGN=LEFT VALIGN=TOP BGCOLOR="#FFFFCC"><B><FONT COLOR="#000000">Cases Opened</FONT></B></TD> 
	...
	{foreach from=$results key=view item=ds}
		<TR> 
			...
			<TD STYLE="border-top: 3px solid #000000; border-bottom: 3px solid #000000; border-left: 3px solid #000000; border-right: 3px solid #000000" COLSPAN=2 ALIGN=CENTER VALIGN=TOP SDVAL="427" SDNUM="1033;0;[$-409]General"><FONT COLOR="#000000">{$results.$view.March}</FONT></TD> 
