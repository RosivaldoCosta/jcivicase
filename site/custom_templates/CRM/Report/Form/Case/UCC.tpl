{include file="CRM/Report/Form/Case/Table.tpl" title="UCC YTD Report"}
...
<TABLE FRAME=VOID CELLSPACING=0 COLS=27 RULES=NONE BORDER=0> 
	...
	<TBODY> 
		<TR> 
			<TD COLSPAN=27 WIDTH=889 HEIGHT=28 ALIGN=CENTER VALIGN=TOP><B><FONT SIZE=4 COLOR="#800000">UCC Report</FONT></B></TD> 
		</TR> 
		<TR> 
