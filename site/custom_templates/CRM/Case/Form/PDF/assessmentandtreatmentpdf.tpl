			...
			<div class='test11'  style='display:block;'>
                ...
                {foreach from=$block.fields item=field key=key}
						...
						{if $field.html_type EQ 'Radio' or $field.html_type EQ 'CheckBox'}{*$key*}
                            {if in_array($key, array( 1424, 1425, 501, 502, 503, 505, 1527))}
							<div class='left' style="width:97px;"><span>{$field.label}:</span></div>
							<div class='right'>
                            {elseif in_array($key, array( 499 ))}
							<div class='left'><span>{$field.label}:</span></div><br/>
