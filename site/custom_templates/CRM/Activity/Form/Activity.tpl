       ...
       {$activityTypeName}
        ...
        {elseif $action eq 1 or $action eq 2  or $action eq 4 or $context eq 'search' or $context eq 'smog'}
            ...
            <table class="{if $action eq 4}view-layout{else}form-layout{/if}">
             ...
             {elseif $action neq 4}
		{if $customDataSubType neq '103' and $customDataSubType neq '94' and $customDataSubType neq '95'}
             <tr>
		...
		<input name="subject" type="hidden" id="subject" value="{$activityTypeName}" />
		<!--
		{if $atype ne 95}
             <tr>
                 ...
                 <!--<tr>
                    <td colspan="2">
                     <div id="follow-up_show" class="section-hidden section-hidden-border">
                      <a href="#" onclick="hide('follow-up_show'); show('follow-up'); return false;"><img src="{$config->resourceBase}TreePlus.gif" class="action-icon" alt="open section"/></a><label>{ts}Schedule Follow-up{/ts}</label><br />
                     </div>
                          
                     <div id="follow-up" class="section-shown">
                       <fieldset><legend><a href="#" onclick="hide('follow-up'); show('follow-up_show'); return false;"><img src="{$config->resourceBase}TreeMinus.gif" class="action-icon" alt="close section"/></a>{ts}Schedule Follow-up{/ts}</legend>
