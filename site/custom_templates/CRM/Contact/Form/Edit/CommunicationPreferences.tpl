            ...
            {if $form.email_greeting_id}
                <td>
                    ...
                    {if $email_greeting_display and $action eq 2}
                        <div id="email_greeting_display" class="view-data">{$email_greeting_display}&nbsp;&nbsp;<a href="#" onclick="showGreeting('email_greeting');return false;"><img src="{$config->resourceBase}edit.png" border="0" title="{ts}Edit{/ts}"></a></div>
                    {/if}
                </td>
            {/if}
            {if $form.postal_greeting_id}
                <td>
                    ...
                    {if $postal_greeting_display and $action eq 2}
                        <div id="postal_greeting_display" class="view-data">{$postal_greeting_display}&nbsp;&nbsp;<a href="#" onclick="showGreeting('postal_greeting');return false;"><img src="{$config->resourceBase}edit.png" border="0" title="{ts}Edit{/ts}"></a></div>
                    {/if}
                </td>
            {/if}
            {if $form.addressee_id}
                <td>
                    ...
                    {if $addressee_display and $action eq 2}
                        <div id="addressee_display" class="view-data">{$addressee_display}&nbsp;&nbsp;<a href="#" onclick="showGreeting('addressee');return false;"><img src="{$config->resourceBase}edit.png" border="0" title="{ts}Edit{/ts}"></a></div>
                    {/if}
                </td>
            {/if}
        </tr>
